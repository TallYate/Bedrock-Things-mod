...
public class ChargedDiamondAxeItem extends AxeItem
{
	public ChargedDiamondAxeItem(IItemTier tier, float attackDamageIn, float attackSpeedIn, Item.Properties builder) {
