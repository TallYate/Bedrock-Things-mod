...
public class ChargedDiamondPickaxeItem extends PickaxeItem
{
	public ChargedDiamondPickaxeItem(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder) {
