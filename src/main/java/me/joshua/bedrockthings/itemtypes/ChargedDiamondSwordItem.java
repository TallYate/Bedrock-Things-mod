...
public class ChargedDiamondSwordItem extends SwordItem
{
	public ChargedDiamondSwordItem(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder) {
